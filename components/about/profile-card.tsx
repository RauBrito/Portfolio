...
export const ProfileCard = memo(function ProfileCard({
  ...
  return (
    <Card className="w-full max-w-3xl mx-auto p-0 md:p-0 mb-12 rounded-2xl dark:shadow-neutral-700 shadow-md overflow-hidden bg-white/90 dark:bg-black/60">
      <div className="flex flex-col mdplus:flex-row items-center md:items-start gap-8">
        ...
        {/* Right Description */}
        <div className="text-muted-foreground text-sm leading-relaxed max-w-3xl px-6 py-4 self-center">
          <CardFooter className="relative bg-black/50 bottom-0 z-10 -ml-3 max-w-60 w-full">
            <div className="flex flex-col text-white w-full">
              <HighlightText className="text-lg font-semibold w-full" text={name} />
              {/* <p className="text-sm text-white/80">{title}</p> */}
            </div>
          </CardFooter>
